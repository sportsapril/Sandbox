...
X$MS_SLS_2017_ALLOCATION_perc[X$MS_SLS_2017_ALLOCATION_perc > 1 | X$MS_SLS_2017_ALLOCATION_perc < 0] = NaN
X$MS_SLS_2017_INTL_EQUITY_perc[X$MS_SLS_2017_INTL_EQUITY_perc > 1 | X$MS_SLS_2017_INTL_EQUITY_perc < 0] = NaN
X$MS_SLS_2017_MUNI_BOND_perc[X$MS_SLS_2017_MUNI_BOND_perc > 1 | X$MS_SLS_2017_MUNI_BOND_perc < 0] = NaN
X$MS_SLS_2017_TAXABLE_BOND_perc[X$MS_SLS_2017_TAXABLE_BOND_perc > 1 | X$MS_SLS_2017_TAXABLE_BOND_perc < 0] = NaN
X$MS_SLS_2017_US_EQUITY_perc[X$MS_SLS_2017_US_EQUITY_perc > 1 | X$MS_SLS_2017_US_EQUITY_perc < 0] = NaN

# Calculate asset share class percentage (not doing the same for sales right now)
X$MS_ASSET_Perc_529 = X$MS_ASSET_VAL2017_529/X$MS_ASSET_2017
X$MS_ASSET_Perc_ABC = X$MS_ASSET_VAL2017_ABC/X$MS_ASSET_2017
X$MS_ASSET_Perc_R = X$MS_ASSET_VAL2017_R/X$MS_ASSET_2017
X$MS_ASSET_Perc_F = X$MS_ASSET_VAL2017_F/X$MS_ASSET_2017
...
# complex_group = X %>%
#   group_by(Asset_Complexity_Group) %>%
#   summarise(pop = n())
...
# X$isNA_Office_AF_as_Total_AUM = 
#   X$isNA_Office_Allocation_Perc_AUM = 
#   X$isNA_Office_Alternative_Perc_AUM = 
#   X$isNA_Office_Commodities_Perc_AUM =
#   X$isNA_Office_FixedIncome_Perc_AUM = 
#   X$isNA_Office_Equity_Perc_AUM = 
#   X$isNA_Office_MoneyMarket_Perc_AUM = 
#   X$isNA_Office_Other_Perc_AUM = 
#   X$isNA_Office_TaxPreferred_Perc_AUM = 
#   X$isNA_MS_ASSET_Perc_529 =
#   X$isNA_Office_MS_ASSET_Perc_ABC = 
#   X$isNA_MS_ASSET_Perc_R =
#   X$isNA_Office_MS_ASSET_Perc_F = 
#   X$isNA_MS_SLS_2017_ALLOCATION_perc =
#   X$isNA_Office_MS_SLS_2017_INTL_EQUITY_perc = 
#   X$isNA_MS_SLS_2017_MUNI_BOND_perc = 
#   X$isNA_MS_SLS_2017_TAXABLE_BOND_perc = 
#   X$isNA_MS_SLS_2017_US_EQUITY_perc = 
#   X$isNA_MS_slsRtmt2017_perc = 
#   X$isNA_MS_slsRetail2017_perc = 
#   X$isNA_MS_slsIRA2017_perc = 0

# X$Office_AF_as_Total_AUM_Group =
#   X$Office_Allocation_Perc_AUM_Group =
#   X$Office_Alternative_Perc_AUM_Group =
#   X$Office_Commodities_Perc_AUM_Group =
#   X$Office_FixedIncome_Perc_AUM_Group =
#   X$Office_Equity_Perc_AUM_Group =
#   X$Office_MoneyMarket_Perc_AUM_Group =
#   X$Office_Other_Perc_AUM_Group =
#   X$Office_TaxPreferred_Perc_AUM_Group =
#   X$MS_ASSET_Perc_529 =
#   X$Office_MS_ASSET_Perc_Group_ABC =
#   X$MS_ASSET_Perc_Group_R =
#   X$Office_MS_ASSET_Perc_Group_F =
#   X$MS_SLS_2017_ALLOCATION_Perc_Group =
#   X$Office_MS_SLS_2017_INTL_EQUITY_Perc_Group =
#   X$MS_SLS_2017_MUNI_BOND_Perc_Group =
#   X$MS_SLS_2017_TAXABLE_BOND_Perc_Group =
#   X$MS_SLS_2017_US_EQUITY_Perc_Group =
#   X$MS_slsRtmt2017_Perc_Group =
#   X$MS_slsRetail2017_Perc_Group =
#   X$MS_slsIRA2017_Perc_Group = 0





ColToBeCat = c('Office_AF_as_Total_AUM'
...
ColOutputCat = c('Office_AF_as_Total_AUM_Group'
